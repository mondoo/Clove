...
namespace blb::rnd {
    ...
    Material::Material(clv::gfx::GraphicsFactory& factory) {
        ...
        if(defaultImage.use_count() == 0) {
            ...
            transferCommandBuffer->imageMemoryBarrier(*image, layoutTransferInfo, clv::gfx::PipelineStage::Top, clv::gfx::PipelineStage::Transfer);
            transferCommandBuffer->copyBufferToImage(*transferBuffer, 0, *image, clv::gfx::ImageLayout::TransferDestinationOptimal, { 0, 0, 0 }, { imageDesc.dimensions.x, imageDesc.dimensions.y, 1 });
            transferCommandBuffer->imageMemoryBarrier(*image, transferQueueReleaseInfo, clv::gfx::PipelineStage::Transfer, clv::gfx::PipelineStage::Transfer);
            ...
            graphicsCommandBuffer->imageMemoryBarrier(*image, graphicsQueueAcquireInfo, clv::gfx::PipelineStage::Transfer, clv::gfx::PipelineStage::PixelShader);
