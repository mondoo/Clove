...
namespace blb::ecs {
    ...
    EntityID PhysicsSystem::rayCast(clv::mth::vec3f const &begin, clv::mth::vec3f const &end) {
        return rayCast(begin, end, ~0, ~0);
    }

    EntityID PhysicsSystem::rayCast(clv::mth::vec3f const &begin, clv::mth::vec3f const &end, uint32_t const collisionGroup, uint32_t const collisionMask) {
