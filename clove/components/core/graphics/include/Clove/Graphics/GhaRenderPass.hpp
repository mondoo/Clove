...
namespace garlic::clove {
    ...
    struct SubpassDependency {
        ...
        GhaGraphicsPipelineObject::Stage sourceStage;      /**< The pipeline stage that gets executed before the dependency in sourceSubpass. */
        GhaGraphicsPipelineObject::Stage destinationStage; /**< The pipeline stage executed after the barrier in destinationSubpass that waits for the results of the sourceStage. */
