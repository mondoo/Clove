...
namespace clove {
    MetalDescriptorSet::MetalDescriptorSet(ArgumentEncoder vertexEncoder, ArgumentEncoder pixelEncoder, ArgumentEncoder computeEncoder, GhaDescriptorSetLayout const *layout)
