...
CLOVE_REFLECT_PROPERTY(position, clove::EditorEditableMember{})
CLOVE_REFLECT_PROPERTY(rotation, clove::EditorEditableMember{})
CLOVE_REFLECT_PROPERTY(scale, clove::EditorEditableMember{})
