...
#include "GraphicsAPI/GL/OLD/Texture.hpp"

namespace clv{
	Material::Material(gfx::ShaderType shaderType)
		: shaderType(shaderType){
		createMaterial("../Clove/res/Textures/DefaultTexture.png");
	}

	Material::Material(const std::string& texturePath, gfx::ShaderType shaderType)
		: shaderType(shaderType){
