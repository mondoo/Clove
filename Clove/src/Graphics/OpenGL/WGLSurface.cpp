...
namespace clv::gfx::ogl {
    WGLSurface::WGLSurface(std::shared_ptr<GraphicsFactory> factory, void* windowData)
        ...
        if(wglCreateContextAttribsARB != nullptr) {
            ...
            GARLIC_LOG(garlicLogContext, garlic::LogLevel::Warning, "Could not retrieve wglCreateContextAttribsARB. Application might not support OpenGL 3.2+ contexts");
    ...
    void WGLSurface::makeCurrent() {
        ...
        if(!wglSwapIntervalEXT || !wglGetSwapIntervalEXT) {
            ...
            if(strstr(extensions, "WGL_EXT_swap_control") != 0) {
                ...
                GARLIC_LOG(garlicLogContext, garlic::LogLevel::Error, "Could not find the WGL_EXT_swap_control extension");
            }
        }
    ...
    void WGLSurface::setVSync(bool enabled) {
        if(wglSwapIntervalEXT) {
            ...
            GARLIC_LOG(garlicLogContext, garlic::LogLevel::Trace, "Swap interval for WGL was set to: {0}", interval);
        } else {
            GARLIC_LOG(garlicLogContext, garlic::LogLevel::Error, "Could not set swap interval. wglSwapIntervalEXT is unitialised. Please make sure this context is current");
        }
    }
    ...
    bool WGLSurface::isVsync() const {
        if(wglGetSwapIntervalEXT) {
            ...
            GARLIC_LOG(garlicLogContext, garlic::LogLevel::Error, "wglGetSwapIntervalEXT is unitialised. Could not retrieve swap interval. Please make sure this context is current");
            return false;
        }
    }
