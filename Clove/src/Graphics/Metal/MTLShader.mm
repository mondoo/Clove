			...
			case ShaderStyle::Unlit_2D:
				{
					...
					std::string vs_string = ShaderTranspiler::compile(source_vs, ShaderStage::Vertex, ShaderType::MSL);
					std::string ps_string = ShaderTranspiler::compile(source_ps, ShaderStage::Pixel, ShaderType::MSL);
