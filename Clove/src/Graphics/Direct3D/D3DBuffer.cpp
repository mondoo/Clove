...
namespace clv::gfx::d3d {
	...
	D3DBuffer::D3DBuffer(std::shared_ptr<GraphicsFactory> factory, ID3D11Device& d3dDevice, const BufferDescriptor& descriptor, const void* data)
	...
	const std::shared_ptr<GraphicsFactory>& D3DBuffer::getFactory() const {
		return factory;
	}
