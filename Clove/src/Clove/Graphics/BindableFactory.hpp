...
namespace clv::gfx::BindableFactory{
	...
	std::shared_ptr<Texture>				createTexture(void* bufferData, int32 width, int32 height, TextureUsage usageType, uint32 bindingPoint, TextureStyle style = TextureStyle::Default);
