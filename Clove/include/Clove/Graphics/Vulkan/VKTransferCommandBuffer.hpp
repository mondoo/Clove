...
namespace clv::gfx::vk {
    ...
    public:
        ...
        void copyImageToBuffer(GraphicsImage &source, mth::vec3i const &sourceOffset, mth::vec3ui const &sourceExtent, GraphicsBuffer &destination, size_t const destinationOffset) override;
