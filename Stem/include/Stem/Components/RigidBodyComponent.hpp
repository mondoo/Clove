...
namespace garlic::inline stem {
	 ...
	 */
    class RigidBodyComponent : public blb::ecs::Component<RigidBodyComponent> {
    ...
    public:
        ...
        void setLinearVelocity(clv::mth::vec3f const &velocity);

        void applyForce(clv::mth::vec3f const &force, clv::mth::vec3f const &relativeOffset = { 0.0f, 0.0f, 0.0f });
        void applyImpulse(clv::mth::vec3f const &impulse, clv::mth::vec3f const &relativeOffset = { 0.0f, 0.0f, 0.0f });

        void setRestitution(float restitution);

        void setAngularFactor(clv::mth::vec3f const &factor);
